...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark"><b>採購排除商品管理</b></h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('gate.dashboard') }}">中繼管理系統</a></li>
                        <li class="breadcrumb-item active"><a href="{{ url('excludeProducts') }}">採購排除商品管理</a></li>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="product_data_add" style="display:none">
                                ...
                                <form class="ProductForm" action="{{ route('gate.excludeProducts.store') }}" method="POST">
                                    @csrf
                                    <div class="card-body">
                                        <div class="row">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center align-middle">
                                            <form action="{{ route('gate.excludeProducts.destroy', $product->id) }}" method="POST">
                                                @csrf
