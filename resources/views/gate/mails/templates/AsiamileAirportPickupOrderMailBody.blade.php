...
<table align="center" border="1" style="border:1px #000000 solid; width:820px">
	<tbody>
		<tr>
			<td style="border-color:#000000; border-style:solid; border-width:1px">Asiamiles 訂購注意事項</td>
		</tr>
		<tr>
			<td>感謝您使用 Asiamiles 里數訂購商品，提供給您商品購買憑証如下：<a href="{{ $details['order']['am_print_link'] }}" target="_blank">{{ $details['order']['am_print_link'] }}</a></td>
		</tr>
		<tr>
			<td><br></td>
		</tr>
		<tr>
			<td>若有任何問題，請不吝聯絡我們，您可以於本信件最下方找到聯絡方式，感謝您的訂購。</td>
		</tr>
	</tbody>
</table>
<br>
...
<p style="text-align:center">Copyright &copy; {{ date('Y') }} icarry.me直流電通股份有限公司｜台北市中山區南京東路三段103號11樓之1</p>
