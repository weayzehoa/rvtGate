...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark"><b>銷貨折讓單管理</b></h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('gate.dashboard') }}">中繼管理系統</a></li>
                        <li class="breadcrumb-item active"><a href="{{ url('sellReturn') }}">銷貨折讓單管理</a></li>
                    ...
                    <div class="card">
                                ...
                                <div class="col-12 mt-2">
                                    <div class="col-8 float-left">
                                        ...
                                        <span class="badge badge-info mr-1"><span class="text-danger text-bold delete-btn" style="cursor:pointer" onclick="removeCondition('sell_date')">X </span>
                                            銷退折讓日期區間：
                                            @if(!empty($return_date)){{ $return_date.' ' }}@else{{ '2015-01-01 00:00:00' }}@endif
                                        ...
                                        @if(!empty($return_no))<span class="badge badge-info mr-1"><span class="text-danger text-bold delete-btn" style="cursor:pointer" onclick="removeCondition('purchase_no')">X</span> 出貨單單號：{{ $return_no }}</span>@endif
                        ...
                        <div class="card-body">
                            <div id="search" class="card card-primary" style="display: none">
                                ...
                                <form id="searchForm" role="form" action="{{ url('sellReturn') }}" method="get">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="row">
                                                    <div class="col-3 mt-2">
                                                        <label for="sell_no">銷退折讓單編號:</label>
                                                        <input type="number" inputmode="numeric" class="form-control" id="return_no" name="return_no" placeholder="銷退折讓單單號" value="{{ isset($return_no) && $return_no ? $return_no : '' }}" autocomplete="off" />
                                                    </div>
                                                    <div class="col-3 mt-2">
                                                        <label for="erp_sell_no">ERP銷退折讓單號:</label>
                                                        <input type="number" inputmode="numeric" class="form-control" id="erp_return_no" name="erp_return_no" placeholder="ERP銷退折讓單編號" value="{{ isset($erp_return_no) && $erp_return_no ? $erp_return_no : '' }}" autocomplete="off" />
                                                    </div>
                                                    <div class="col-3 mt-2">
                                                    ...
                                                    <div class="col-6 mt-2">
                                                        <label class="control-label" for="return_date">銷退折讓日期區間:</label>
                                                    ...
                                                    <tbody>
                                                        <form id="itemsform_order_{{ $return->id }}" method="POST">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-left align-middle text-sm">{{ !empty($item->product_name) ? $item->product_name : $item->memo }}</td>
...
<div id="importModal" class="modal fade bd-example-modal-xl" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
    ...
    <form id="cancelForm" action="{{ url('sellReturn/cancel') }}" method="POST">
        @csrf
    </form>
</div>
@endsection
