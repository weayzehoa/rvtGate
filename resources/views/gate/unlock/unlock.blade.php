...
<head>
    ...
    @if(env('APP_ENV') == 'local')<title>iCarry 測試用中繼管理系統 - 解鎖</title>@else<title>iCarry 中繼管理系統 - 解鎖</title>@endif
    ...
    <div class="login-box">
        ...
        <div class="card">
            <div class="card-body login-card-body">
                <p class="login-box-msg">請輸入要解除鎖定的帳號及Email</p>
                <form id="loginForm" action="{{ route('unlockAccount.submit') }}" method="post">
                    @csrf
                    ...
                    <div class="input-group mb-3">
                        <input id="email" type="email" placeholder="請輸入電子郵件信箱" class="form-control {{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" required>
                        <div class="input-group-append">
                            <div class="input-group-text">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            <button type="button" class="btn btn-primary btn-block btn-submit">解鎖</button>
                        </div>
                    </div>
                </form>
            </div>
