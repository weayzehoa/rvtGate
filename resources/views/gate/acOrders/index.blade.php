...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark"><b>錢街串接訂單管理</b></h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('gate.dashboard') }}">中繼管理系統</a></li>
                        <li class="breadcrumb-item active"><a href="{{ url('acOrders') }}">錢街串接訂單管理</a></li>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-7">
                                    ...
                                    <button id="orderImport" class="btn btn-sm btn-warning">匯出發票資訊</button>
                                    @endif
                                    <button id="multiSearch" class="btn btn-sm btn-primary">金流多筆查詢</button>
                                </div>
                                <div class="col-5">
                                ...
                                {{-- <div class="col-12 row mt-2">
                                    <div class="col-7">
                                        ...
                                        @endforeach
                                        <a href="{{ env('APP_URL').'/orders' }}" class="{{ !empty($book_shipping_date) && $book_shipping_date == $bookShippingDate->book_shipping_date ? 'btn-primary' : 'fc-button text-primary' }} btn btn-sm mr-1 mt-1">清除選項</a>
                                    </div>
                                    <div class="col-5">
                                        ...
                                        @endforeach
                                        <button class="fc-button text-primary btn btn-sm mr-1 mt-1"><span class="badge badge-sm badge-secondary">清除選擇</span></button>
                                    </div>
                                </div> --}}
                        ...
                        <div class="card-body">
                            <div id="orderSearchForm" class="card card-primary" style="display: none">
                                ...
                                <form id="searchForm" role="form" action="{{ url('acOrders') }}" method="get">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-6 mt-2">
                                                ...
                                                <select class="form-control" id="status" size="4.5" multiple>
                                                ...
                                                </select><input type="hidden" value="1,2,3,4" name="status" id="status_hidden" />
                                            </div>
                                            <div class="col-6">
                                                <div class="row">
                                                    <div class="col-6 mt-2">
                                                    ...
                                                    <div class="col-6 mt-2">
                                                        <label for="partner_order_number">ACpay金流序號:</label>
                                                        <input type="text" class="form-control" id="partner_order_number" name="partner_order_number" placeholder="輸入ACpay金流序號" value="{{ isset($partner_order_number) && $partner_order_number ? $partner_order_number : '' }}" autocomplete="off" />
                                                    </div>
                                                    <div class="col-6 mt-2">
                        ...
                        <div class="col-12"  style="overflow: auto">
                                <table class="table table-hover table-sm">
                                    <thead class="thead-dark">
                                        <tr>
                                            <th class="text-left" width="30%">訂單資訊 / 訂單狀態 / 物流及金流</th>
                                            <th class="text-left" width="70%">購買品項<br></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="text-left align-top p-0">
                                                <div>
                                                    ...
                                                    <a href="{{ url('orders?order_number='.$order->order_number) }}" target="_blank">
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        ...
                                                        @else
                                                        <span class="text-sm">發票：尚未開立</span>
                                                        @endif
                                                        @endif
                                                    </div>
                                                    <div class="col-6">
                                                ...
                                                <div class="row">
                                                    <div class="col-6 text-sm">
                                                        ...
                                                        發票折讓號碼：{{ $order->invoiceAllowance->allowance_no }}<br>
                                                        發票折讓金額：<span class="badge badge-primary">{{ number_format($order->invoiceAllowance->allowance_amt) }}</span>
                                                        @endif
                                                    </div>
                                                    <div class="col-6 text-sm">
                                                        @if(count($order->sellReturns) > 0)
                                                ...
                                                <div class="row mb-1">
                                                    <div class="col-6 text-sm">
                                                        ...
                                                        串接資料：<span><a href="javascript:" class="badge badge-danger" data-toggle="popover" title="{{ $order->acOrder->serial_no }}" data-content="
                                                            <small>
                                            ...
                                            <td class="text-left align-top p-0">
                                                <table class="table table-sm">
                                                    <thead class="table-info">
                                                        ...
                                                        <th width="6%" class="text-right align-middle text-sm">數量</th>
                                                        <th width="6%" class="text-right align-middle text-sm">出貨</th>
                                                        <th width="6%" class="text-right align-middle text-sm">退貨</th>
                                                        <th width="8%" class="text-right align-middle text-sm">物流</th>
                                                        <th width="6%" class="text-right align-middle text-sm">總價</th>
                                                    </thead>
                                                    <tbody>
                                                        <form id="itemsform_order_{{ $order->id }}" method="POST">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-center align-middle text-sm {{ $item->is_del == 1 || $item->quantity == 0 ? 'double-del-line' : '' }}" style="{{ strstr($item->sku,'BOM') ? 'border-top:1px #000000 solid;' : 'border-top:1px #000000 solid;border-bottom:1px #000000 solid;' }}">{{ strstr('點',$item->unit_name) ? '組' : '' }}</td>
                                                                <td class="text-right align-middle text-sm {{ $item->is_del == 1 || $item->quantity == 0 ? 'double-del-line' : '' }}" style="{{ strstr($item->sku,'BOM') ? 'border-top:1px #000000 solid;' : 'border-top:1px #000000 solid;border-bottom:1px #000000 solid;' }}">{{ number_format($item->quantity) }}</td>
                                                            ...
                                                            @endforeach
                                                            <tr>
                                                                <td colspan="3" class="text-left align-middle text-sm text-primary text-bold" style="border-top:1px #000000 solid;border-bottom:1px #000000 solid;"></td>
                                                                <td colspan="2" class="text-right align-middle text-sm text-primary text-bold" style="border-top:1px #000000 solid;border-bottom:1px #000000 solid;">商品總計</td>
                                                                <td class="text-right align-middle text-sm text-primary text-bold" style="border-top:1px #000000 solid;border-bottom:1px #000000 solid;">1</td>
                                                                <td class="text-right align-middle text-sm text-primary text-bold" style="border-top:1px #000000 solid;border-bottom:1px #000000 solid;">1</td>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form  id="importForm" action="{{ url('orders/import') }}" method="POST" enctype="multipart/form-data">
                    <input type="hidden" name="cate" value="acorders">
                    <input type="hidden" name="type" value="錢街發票資訊">
                    @csrf
                ...
                <div>
                    <span class="text-danger">注意! 請選擇正確的匯入檔案，否則將造成資料錯誤。<a href="{{ 'https://'.env('GATE_DOMAIN').'/sample/錢街金流序號範例.xlsx' }}" class="mb-3 mr-3" target="_blank">錢街金流序號範例</a></span>
                </div>
            </div>
        </div>
    </div>
...
{{-- 多筆查詢 Modal --}}
<div id="multiSearchModal" class="modal fade bd-example-modal-xl" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl" style="max-width: 60%;">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="multiSearchModalLabel">請填入要查詢的金流交易序號</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form  id="multiSearchForm" action="{{ url('acOrders') }}" method="GET">
                    <div class="form-group">
                        <div class="input-group">
                            <textarea class="form-control" id="multiSearchTextarea" rows="10" name="multiSearch" placeholder="請填入要查詢的金流交易序號，一筆一行金流序號資料，請勿留任何空白或其他符號。範例如下:
AA240314bOSlDR5521
AA240314bOSlDR5522
AA240314bOSlDR5523
AA240314bOSlDR5524
AA240314bOSlDR5525">{{ isset($multiSearch) && $multiSearch ? $multiSearch : '' }}</textarea>
                            <div class="input-group-append">
                                <button id="searchBtn" type="submit" class="btn btn-md btn-primary btn-block">查詢</button>
                            </div>
                        </div>
                    </div>
                </form>
...
<script>
    (function($) {
        ...
        $('#multiSearchTextarea').click(function(){
            $('#multiSearchTextarea').html('');
        });
