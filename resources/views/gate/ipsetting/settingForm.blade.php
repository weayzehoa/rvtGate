    ...
    <div class="login-box">
        ...
        <div class="card">
            <div class="card-body login-card-body">
                <p class="login-box-msg">請輸入 帳號 與 電話號碼</p>
                <form id="loginForm" action="{{ route('ipsetting.submit') }}" method="post">
                    @csrf
                    ...
                    <div class="input-group mb-3">
                        <input id="mobile" type="text" placeholder="輸入電話號碼，國際電話需填+號" class="form-control {{ $errors->has('mobile') ? ' is-invalid' : '' }}" name="mobile" value="{{ old('mobile') }}" required>
                        <div class="input-group-append">
                            <div class="input-group-text">
