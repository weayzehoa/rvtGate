...
class OrderLowPriceInvoiceSheet implements FromCollection,WithStrictNullComparison,WithStyles,WithTitle,WithColumnWidths
{
        ...
        if(!empty($orders)){
            ...
            foreach ($orders as $order) {
                ...
                foreach($order->items as $item){
                    ...
                    $vendorId = $item->model->product->vendor_id;
                    $categoryId = $item->model->product->category_id;
                    /* 2018/08/29  陳哲儒 因應Tesla 的要求因此要*0.5 PS:*0.033是美金 */
                    /* 此外『飲品茶葉』& 【蜂蜜世界、蜂蜜故事館、蜜蜂阿虎】的商品*0.3 PS:*0.033是美金 */
                    if($vendorId == 235 || $vendorId == 228 || $vendorId == 190 || $categoryId == 3){
