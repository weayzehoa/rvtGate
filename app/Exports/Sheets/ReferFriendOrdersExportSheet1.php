...
class ReferFriendOrdersExportSheet1 implements FromCollection,WithStrictNullComparison,WithStyles,WithTitle,WithHeadings,ShouldAutoSize,WithColumnWidths
{
    protected $param;
    ...
    */
    ...
    public function title(): string
    {
        $year = $this->param['year'];
        $month = $this->param['month'];
        $title = "有填寫註冊推薦碼且為 $year 年 $month 月註冊者";
        return $title;
    }
